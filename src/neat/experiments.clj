...
(defn glass 
  ...
  (let [dataset (co/to-matrix (io/read-dataset (str dataset-prefix "glass.data")))]
    ...
    (dosync 
     ...
     (ref-set ep/fitness-fun
              (make-classification-fitness (co/to-vect  (co/sel dataset :cols (range 1 10)))
